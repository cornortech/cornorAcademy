    ...
    <div className="flex h-full flex-col bg-card border-r border-border/50">
      ...
      <nav className="flex-1 space-y-0.5 overflow-y-auto p-3">
        ...
        <button
          ...
          className={cn(
            "flex w-full items-center gap-3 text-sm font-medium transition-colors rounded-md text-muted-foreground hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30",
      ...
      >
        <div className="flex h-full flex-col bg-card border-r border-border/50">
          ...
          <nav className="flex-1 space-y-0.5 overflow-y-auto p-3">
            ...
            <button
              onClick={() => { logout(); onMobileClose(); }}
              className="flex w-full items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors rounded-md text-muted-foreground hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30"
            >
              <LogOut className="h-5 w-5 shrink-0" />
