      ...
      <div className="space-y-4 text-sm leading-relaxed">
        <section>
          ...
          <p className="text-muted-foreground">
            This agreement is entered into between Cornor Academy ("Academy")
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            Cornor Academy shall not be liable for any indirect, incidental, or
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            ...
            the laws of the jurisdiction in which Cornor Academy operates. Any
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            Cornor Academy reserves the right to modify these terms and
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            ...
            and Cornor Academy regarding course enrollment and supersedes all
